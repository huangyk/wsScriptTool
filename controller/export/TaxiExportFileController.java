...
@WSRestController(path = "/TaximyWorkSpace/export", module = "文件下载")
public class TaxiExportFileController extends AbstractManagerBaseController {
    private static Logger logger = LoggerFactory.getLogger(TaxiExportFileController.class);
