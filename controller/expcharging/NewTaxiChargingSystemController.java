...
@WSRestController(path = "/newtaxi/charging/system", module = "平台计费-新出租车计费规则")
public class NewTaxiChargingSystemController extends AbstractManagerBaseController {
    ...
    public AnwserCode export(ExpChargingAo ao) {
        ao.setNewTaxi(true);
        ao.setRideTypeList(rideTypeList);
        return expChargingService.export(ao, ChargingServiceUtil.WANSHUNSYSTEM, OrderAttributeConst.ORDER_TYPE_EXPCAR_INSTANT, FileExportModuleConstant.NEW_TAXI_CHARGING_SYSTEM);
    }
