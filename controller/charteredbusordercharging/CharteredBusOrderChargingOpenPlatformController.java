...
@WSRestController(path = "/charteredbusorder/charging/openPlatform", module = "开放平台-包车计费规则")
public class CharteredBusOrderChargingOpenPlatformController extends AbstractManagerBaseController {

	@Autowired
	private RpcCharteredBusOrderChargingConsoleService rpcCharteredBusOrderChargingConsoleService;

	@OpRequestSelectMapping(op = "selectPage", desc = "开放平台-包车计费规则--分页查询")
	public List<RpcCharteredBusOrderChargingConsoleVo> selectPage(PageModel<RpcCharteredBusOrderChargingConsoleAo> ao) {
		ao.getBody().setChannelType(ChargingServiceUtil.OPENPLATFORM);
	...
	@OpRequestSelectMapping(op = "selectCount", desc = "开放平台-包车计费规则--数量查询")
	...
	@OpRequestUpdateMapping(op = "delete", desc = "开放平台-包车计费规则-删除")
	...
	@OpRequestSaveMapping(op = "save", desc = "开放平台-包车计费规则-添加")
	...
	@OpRequestUpdateMapping(op = "update", desc = "开放平台-包车计费规则-修改")
	...
	@OpRequestUpdateMapping(op = "batchAdjust", desc = "开放平台-包车计费规则-批量调整配置")
	...
	@OpRequestUpdateMapping(op = "batchUpdateUpStatus", desc = "开放平台-包车计费规则-批量启用")
	...
	@OpRequestUpdateMapping(op = "batchUpdateDownStatus", desc = "开放平台-包车计费规则-批量停用")
	...
	@OpRequestUpdateMapping(op = "batchUpdateDelStatus", desc = "开放平台-包车计费规则-批量删除")
	...
	@OpRequestSelectMapping(op = "batchSave", desc = "开放平台-包车计费规则-批量新增")
	...
	@OpRequestSelectMapping(op = "export", desc = "开放平台-包车计费规则-导出")
	public AnwserCode export(RpcCharteredBusOrderChargingConsoleAo ao){
		ao.setChannelType(ChargingServiceUtil.OPENPLATFORM);
		ao.setUserId(TokenUtils.getCurrentUser().getId());
		ao.setModule(AttributeConst.CHARGING_MANAGER_MODULE);
		ao.setFileType(FileExportModuleConstant.CHARTERED_BUS_ORDER_CHARGING_OPEN_PLATFORM);
