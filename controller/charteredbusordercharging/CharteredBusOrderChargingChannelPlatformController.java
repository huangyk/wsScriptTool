...
@WSRestController(path = "/charteredbusorder/charging/channel", module = "H5渠道-包车计费规则")
public class CharteredBusOrderChargingChannelPlatformController extends AbstractManagerBaseController {

	@Autowired
	private RpcCharteredBusOrderChargingConsoleService rpcCharteredBusOrderChargingConsoleService;

	@OpRequestSelectMapping(op = "selectPage", desc = "H5渠道-包车计费规则-分页查询")
	public List<RpcCharteredBusOrderChargingConsoleVo> selectPage(PageModel<RpcCharteredBusOrderChargingConsoleAo> ao) {
		ao.getBody().setChannelType(ChargingServiceUtil.CHANNELPLATFORM);
	...
	@OpRequestSelectMapping(op = "selectCount", desc = "H5渠道-包车计费规则-数量查询")
	...
	@OpRequestUpdateMapping(op = "delete", desc = "H5渠道-包车计费规则-删除")
	...
	@OpRequestSaveMapping(op = "save", desc = "H5渠道-包车计费规则-添加")
	...
	@OpRequestUpdateMapping(op = "update", desc = "H5渠道-包车计费规则-修改")
	...
	@OpRequestUpdateMapping(op = "batchAdjust", desc = "H5渠道-包车计费规则-批量调整配置")
	...
	@OpRequestUpdateMapping(op = "batchUpdateUpStatus", desc = "H5渠道-包车计费规则-批量启用")
	...
	@OpRequestUpdateMapping(op = "batchUpdateDownStatus", desc = "H5渠道-包车计费规则-批量停用")
	...
	@OpRequestUpdateMapping(op = "batchUpdateDelStatus", desc = "H5渠道-包车计费规则-批量删除")
	...
	@OpRequestSelectMapping(op = "batchSave", desc = "H5渠道-包车计费规则-批量新增")
	...
	@OpRequestSelectMapping(op = "export", desc = "H5渠道-包车计费规则-导出")
	public AnwserCode export(RpcCharteredBusOrderChargingConsoleAo ao){
		ao.setChannelType(ChargingServiceUtil.CHANNELPLATFORM);
		ao.setUserId(TokenUtils.getCurrentUser().getId());
		ao.setModule(AttributeConst.CHARGING_MANAGER_MODULE);
		ao.setFileType(FileExportModuleConstant.CHARTERED_BUS_ORDER_CHARGING_CHANNEL_PLATFORM);
